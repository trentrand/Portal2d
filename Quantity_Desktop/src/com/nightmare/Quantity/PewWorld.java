...
import com.nightmare.Quantity.Character;
...
//		CBot cb = new CBot(200, 100);
//		add(cb);
		
//		PushCube pc = new PushCube(600, 100);
//		add(pc);
//		
//		Wobot wb = new Wobot(250, 100, 1000);
//		add(wb);
...
//		 setCameraOn(player);
		...
		Text_Entity te = new Text_Entity(5, this.height - 22, font, "Quantity Beta 0.3 - " + osType);
		add(te);
		te.depth = 1000;
...
//		 setCameraOn(player);
	...
	public static void loadQuantities() {
		if (levelNum == 1) {
			...
			Quantities.arrows = 2;
			Quantities.springsup = 2;
			Quantities.launchers = 2;
		}
	}
